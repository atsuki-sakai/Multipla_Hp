  ...
  return (
    <>
      ...
      <Container>
        ...
        >
          <h1 className="text-xl md:text-3xl font-bold text-center title-font">
            お問い合わせ
          </h1>
          ...
          <div>
            <div className="max-w-lg mx-auto">
              <p className="text-gray-500 pt-2 text-sm md:text-lg">
                お問い合わせにつきましては、以下の窓口よりお受けしております。
                なお、お問い合わせ内容によっては、回答にお時間がかかる場合があります。
              </p>
            </div>
            <p className="my-3 text-xl text-gray-800 font-bold pt-8">
              マルチプラへのご依頼、疑問など何でもお気軽にご質問下さい。
            </p>
            <div className="max-w-2xl mx-auto">
              <a target="_blank" href="https://lin.ee/CPF8FeZ" rel="noreferrer">
                <div className="flex justify-center items-center my-12 px-2 border py-3 rounded-md shadow-md space-x-2 bg-green-500">
                  <p className="grow w-64 text-white tracking-wide text-sm md:text-base lg:text-xl">
              ...
              <div className="mt-6 max-w-6xl mx-auto">
                <form className="">
                  <CustomSelect
                    ...
                    name="message-type"
                    label="お問合せ内容"
                    options={contactType_list}
                  />
                  <CustomSelect
                    defaultText="ご予算を選択して下さい"
                    id="money-type"
                    name="money-type"
                    label="ご予算"
                    options={moneyType_list}
                  />
                  <CustomSelect
                    defaultText="ご希望納期を選択して下さい"
                    id="deliverydatetype-list"
                    name="deliverydatetype-list"
                    label="ご希望納期"
                    options={deliveryDateType_list}
                  />
                  <Field
                    value={name}
                    autoComplete={"name"}
                  ...
                  <div className="text-left">
                    ...
                    <textarea
                      ...
                      className="w-full p-2 text-gray-600 bg-indigo-50 outline-none rounded-md"
                    ></textarea>
                  </div>
                  <div className="flex items-center justify-center mt-4">
                    <input
                      className="h-5 w-5 foucs:outline-none"
                      type="checkbox"
                      onChange={() => setPrivacyPolivy(!isPrivacyPolicy)}
                    />
                    <p className="ml-4 text-blue-500 underline text-xs md:text-sm">
                  ...
                  <p className="text-xs h-4 text-red-500 mt-1">
                  ...
                  <div className="flex justify-center">
                    <button
                      ...
                      className="mt-8 mb-3 text-lg font-bold text-gray-900 rounded-md"
                    >
                      <p
                        className={`px-6 py-3 rounded-md shadow-md transform duration-300 ease-in-out ${
                          disabled
                            ? "bg-gray-500 border-2 border-gray-200  text-gray-400"
