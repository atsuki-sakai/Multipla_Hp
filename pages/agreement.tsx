        ...
        <>
            ...
            >
                <Container>
                    ...
                    <h3 className='sm:text-3xl text-2xl font-bold text-center title-font pb-2'>ご契約の流れ</h3>
                    <motion.div
                        ...
                        <div className='mx-auto max-w-2xl  rounded-md shadow-md bg-gradient-to-tr to-green-400 from-lime-400 p-5'>
                            <div className='md:flex items-center'>
                                <div className='w-full'>
                                    <p className='text-white font-bold text-left text-lg'>契約時に必要な物</p>
                                    <ul className='text-white text-left list-disc ml-8 text-sm font-bold'>
                                        <li>メールアドレス</li>
                                        <li>パスワード</li>
                                        <li>クレジットカード</li>
                                    </ul>
                                ...
                                <div className='mt-3 w-full'>
                                    <p className='text-gray-500 rounded-md text-xs w-full text-left bg-white p-3'>
                                        クレジットカードはShopifyの登録時に必要となります。その他サイト構築に必要な商品データ、商品画像、商品説明、バナーなどをご準備いただきます。弊社ではShopifyアカウントの登録も行なっていますので、ご自分で登録できない方でも安心です。
                                    </p>
                                </div>
                            </div>
                        </div>
