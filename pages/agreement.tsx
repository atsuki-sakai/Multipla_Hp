  ...
  return (
    <>
      <MetaHead
        ...
        description={
          "マルチプラ/Multiplaへの制作依頼の大まかな流れを簡単にご案内。制作の打ち合わせは完全オンラインで制作。お時間が少ないお客様でも無理なく利用できます。"
        }
      >
        <script
      ...
      <Container>
        ...
        <h1 className="sm:text-3xl text-2xl font-bold text-center title-font pb-2">
          ご契約の流れ
        </h1>
        <motion.div
          ...
          <div className="in-range:">
            <div className="max-w-6xl mx-auto">
              <div className="h-fit py-6">
                <div className="pb-12">
                  <h5 className="text-center font-bold text-xl md:text-2xl lg:text-3xl mt-12">
                    制作依頼から納品まで
                  </h5>
                  <div className="relative flex justify-center items-center">
                    ...
                    <h4 className="mb-6 ml-3 text-center mt-6 font-bold text-green-500 text-xl md:text-2xl lg:text-3xl">
                      全てオンライン上で完結
                    </h4>
                  </div>
                  <div className="mt-6">
                    <p className="text-center text-sm md:text-base  text-gray-600">
                      制作の打ち合わせはオンラインまたは、お近くでしたら
                      <br />
                      直接でも選択いただけます！
                    </p>
                    <p className="text-center text-sm md:text-base  text-gray-600 mb-4">
                      お時間が少ないお客様でも無理なく利用できます!
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-center">
                  <div className="h-full space-y-4 bg-gray-50 p-3 rounded-md shadow-md shadow-gray-300 max-w-sm mx-auto">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <p className="text-xs md:text-sm text-center font-bold">
                          <span className="text-2xl">1</span>営業日以内に
                          <span className="text-lg">即日返信</span>
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-2 mx-2 justify-center">
                      ...
                      <span className="text-xs md:text-sm text-gray-600 text-left">
                        ECサイト構築の場合は
                        ...
                        よりお問い合わせ下さい。
                        <a
                          href="https://lin.ee/KDk1uI3"
                          className="underline text-blue-500"
                        >
                          LINE
                        </a>
                        でのお問い合せもございますのでお気軽にお問合せください。
                      </span>
                    </div>
                  </div>
                  <div className="h-full space-x-4 bg-gray-50 p-3 rounded-md shadow-md shadow-gray-300 max-w-sm mx-auto">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <p className="text-xs md:text-sm text-center font-bold">
                          最短<span className="text-2xl">2</span>日で
                          <span className="text-lg">ご提案</span>
                        </p>
                      </div>
                    </div>
                    <div className="h-[1px] w-auto mx-4 bg-gray-300"></div>
                    <div className="grid grid-cols-1 gap-2 mx-2 justify-center">
                      ...
                      <span className="text-xs md:text-sm text-left text-gray-600">
                        ご要望をお伺いし、貴社にビジネスに最適なサイトをご提案致します。素材の準備も依頼したい場合は承っておりますのでお気軽にお申し付けください。
                      </span>
                    </div>
                  </div>
                  <div className="h-full space-y-4 bg-gray-50 p-3 rounded-md shadow-md shadow-gray-300 max-w-sm mx-auto">
                    <div className="flex items-center space-x-4">
                      <div className="flex justify-start w-fit px-2 bg-green-500 rounded-full shadow-md">
                        <span className="text-lg md:text-cl font-bold text-white">
                          3
                        </span>
                      </div>
                      <div>
                        <p className="text-xs text-center font-bold md:text-sm">
                          最短<span className="text-2xl">5</span>日で
                          <span className="text-lg">ご提案</span>
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-2 mx-2 justify-center">
                      ...
                      <span className="text-xs md:text-sm text-left text-gray-600">
                        商品画像、商品説明文、サイトを構成する素材、フォント、色味具体的に決めていきます。ご準備いただきサイトの構成を決定します。
                      </span>
                    </div>
                  </div>
                  <div className="h-full space-y-4 bg-gray-50 p-3 rounded-md shadow-md shadow-gray-300 max-w-sm mx-auto">
                    <div className="flex items-center space-x-4">
                      ...
                      <p className="text-xs md:text-sm text-center font-bold">
                        最短<span className="text-2xl">7</span>日で
                        <span className="text-ld">構築</span>
                      </p>
                    </div>
                    <div className="h-[1px] w-auto mx-4 bg-gray-300"></div>
                    <div className="grid grid-cols-1 gap-2 mx-2 justify-center">
                      ...
                      <span className="text-xs md:text-sm text-left text-gray-600">
                        お客様のイメージ、要望を元にサイトを構築していきます。その際リアルタイムで進捗状況を確認することが可能ですのでよりイメージに近づける事がことが可能です。
                      </span>
                    </div>
                  </div>
                  <div className="h-full space-y-4 bg-gray-50 p-3 rounded-md shadow-md shadow-gray-300 max-w-sm mx-auto">
                    <div className="flex items-center space-x-4">
                      ...
                      <p className="text-xs md:text-sm text-center font-bold ">
                        最短<span className="text-2xl">14</span>日で
                    ...
                    <div className="grid grid-cols-1 gap-2 mx-2 justify-center">
                      ...
                      <span className="text-xs md:text-sm text-left text-gray-600">
                        完成したサイトのデザイン、各種機能のテスト、テスト決済、テスト注文などテストした上で最後にお客様に確認して頂きますのでバグを事前に防ぎます。必要書類については別途お送りいたします。
                      </span>
                    </div>
                  </div>
                  <div className="h-full space-y-4 bg-gray-50 p-3 rounded-md shadow-md shadow-gray-300 max-w-sm mx-auto">
                    ...
                    <div className="grid grid-cols-1 gap-2 mx-2 justify-center">
                      ...
                      <span className="text-xs md:text-sm text-left text-gray-600">
                        構築後思うように成果が出ないなどお悩みがありましたら、構築後サポートプランを契約して頂くことも可能ですので安心してご利用いただけます。
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div className="mx-auto max-w-2xl  rounded-md shadow-md bg-gradient-to-tr to-green-500 from-lime-400 p-5">
            <div className="md:flex items-center">
              <div className="w-full">
                <p className="text-white font-bold text-left text-lg md:text-xl">
                  契約時に必要な物
                </p>
