    ...
    return (
        <>
            ...
            <Container>
                ...
                <h1 className='text-2xl md:text-4xl text-center title-font font-bold mb-8'>ご契約プランについて</h1>
                <motion.div
                ...
                >
                    ...
                    <div className='mt-12 mb-6 text-center'>
                        <h3 className='text-2xl lg:text-4xl  font-bold  text-center title-font text-gray-800  mb-4'>サイト製作費用</h3>
                        <p className='text-center text-red-400 text-sm border border-red-300 w-fit mx-auto px-3 py-1 rounded-lg'>
                            ECサイト・WEBサイト制作のお客様はサーバー費用、サイト管理費として別途<span className='text-base font-bold'>月額4800円</span>が必要になります。
                        </p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 max-w-7xl xl:mx-auto">
                        ...
                        <PlanCard
                            ...
                            hideShopifyLogo={true}
                            priceText={"30"}
                            planDescription={"マルチプラの自動お見積りシステムの様にお客様に対して個別で個別で料金を計算するなどのシステムの開発。例えばあるコスメメーカーでは年齢や肌の色、好みを入力するとその人に合ったコスメをおすすめしてくれます。気になる点がございましたらお気軽にお問合せください。"}
                            functionsList={[
                                "要相談"
                            ]}
                        />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 max-w-7xl mx-8 xl:mx-auto">
                        <PlanCard
                            ...
                            isShopifyPlan={true}
                            hideShopifyLogo={true}
                            planDescription={"サイトの制作後の軽度の更新作業から、バグへの対応などサイトの管理・保守作業を承ります。サイトのトラブルは全てマルチプラが対応させて頂きます。"}
                            functionsList={[
                                "バグの修復(4時間/月)",
                                "サイト改善点の提案",
                                "運営業務にまつわる相談",
