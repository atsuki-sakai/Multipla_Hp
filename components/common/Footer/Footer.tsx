        ...
        <footer className={style.root}>
            ...
            <div className="hidden sm:flex sm:items-center sm:justify-between">
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="https://www.facebook.com/multipla.web/" aria-label="FaceBook" className={style.sns_icon}>
                    ...
                    <a href="https://www.instagram.com/multipla.io/" aria-label="Instagram" className={style.sns_icon}>
