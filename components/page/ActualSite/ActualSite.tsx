  ...
  return (
    <div className="bg-gray-200 w-full">
      <div className="md:mx-auto lg:w-1/2 px-8 md:px-12 py-6 md:py-12 lg:py-24 font-noto_sans">
        ...
        <p className="hidden text-center text-gray-500 font-noto text-xl py-12">
          現在制作実績はありません。
        </p>
        <motion.div
          className="pt-8"
        ...
        <motion.div
          ...
          transition={{ duration: 0.8, delay: 0.2 }}
        >
          <Link href={"https://itachiya-sasayama.com"}>
            <a target="_blank">
              <div className="relative w-full pb-6 rounded-md border shadow-md mb-12 bg-secondary overflow-hidden bg-white">
                <div className="relative w-full h-fit  mx-auto hover:scale-105 transform duration-700 ease-in-out">
                  <Image
                    src="/images/itachiya.png"
                    layout="responsive"
                    width={600}
                    height={350}
                    alt="wealthystore link"
        ...
        <motion.div
          ...
          transition={{ duration: 0.8, delay: 0.2 }}
        >
          <Link href={"https://maboroshio-ya.vercel.app/"}>
            <a target="_blank">
              <div className="relative w-full pb-6 rounded-md border shadow-md mb-12 bg-secondary overflow-hidden bg-white">
                <div className="relative w-full h-fit  mx-auto hover:scale-105 transform duration-700 ease-in-out">
                  <Image
                    src="/images/maboroshi-ya.png"
                    layout="responsive"
                    width={600}
                    height={350}
                    alt="wealthystore link"
