      ...
      <div className={style.root}>
        <div className="w-full mx-auto">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="items-end justify-center max-w-7xl mx-auto">
              <div className="md:flex md:flex-row-reverse justify-center my-12 md:my-16 lg:my-20">
                ...
                >
                  <div className="max-w-lg w-fit p-3 md:p-6 bg-white border shadow-md mt-4 md:-mt-12 rounded-md mx-auto relative tracking-[1px]">
                    ...
                    <p className="font-bold text-xl md:text-2xl lg:text3xl py-2 md:py-3 lg:py-6">
                      制作・集客・収益化までを
                      <br />
                      一貫してサポート致します
                    </p>
                    <p className="text-xs md:text-sm lg:text-base text-left text-gray-500">
          ...
          <div className="relative w-full h-full mt-12 md:mt-20">
            <div className="w-fit mx-auto">
              <motion.div
                ...
                transition={{ duration: 0.8 }}
                className={style.sales_container}
              >
                <p>・ECサイト制作</p>
                <p>・WEBサイト制作</p>
                <p>・ホームページ制作</p>
            ...
            <div className="absolute top-0 left-0 -z-10 w-screen shadow-lg rounded-full h-[300px] md:h-[500px] bg-gradient-to-tl to-gray-300 from-white translate-x-32 md:translate-x-72 -translate-y-24 md:-translate-y-52"></div>
          </div>
          <div className="h-0.5 w-1/2 my-12 md:my-24 mx-auto bg-gray-200 rounded-full"></div>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            ...
            transition={{ duration: 0.8 }}
          >
            <p className="text-center mt-4 md:mt-8 text-gray-700 lg:mt-12 text-base md:text-xl lg:text-2xl pb-6 md:pb-12">
              上記以外のお問合せにも対応いたします。
              <br />
              お気軽にご相談ください。
            </p>
