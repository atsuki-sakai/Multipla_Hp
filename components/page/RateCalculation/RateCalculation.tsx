        ...
        <div className='relative bg-white '>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 md:max-w-6xl md:mx-auto relative'>
                ...
                <div>
                    ...
                    <div className='p-4 text-base md:text-lg bg-gradient-to-tr to-cyan-700 from-sky-700 rounded-md space-y-2 text-left shadow-md shadow-gray-300 mx-8'>
                ...
                {/* PRODUCT PRICE */}
                <div className='p-3 bg-gradient-to-tr to-cyan-700 from-sky-700 rounded-xl h-fit md:w-80 lg:w-auto md:sticky top-44 md:right-0 lg:right-20 xl:right-42 2xl:right-60 shadow-md mx-8'>
            ...
            <div className="mx-8 pt-8 md:pt-12 lg:pt-16">
                <div className="max-w-5xl flex  justify-center mx-auto">
                    <button onClick={() => adoptionCanpaign()}>
                        <div className={`z-10 text-white w-full py-2 px-1 md:px-4  ${campaign ? "bg-gray-500 text-gray-200" : "bg-gradient-to-tr to-cyan-700 from-blue-700 hover:scale-105"} rounded-full shadow-md transform duration-200 ease-in-out`}>
