                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 md:mt-20 max-w-7xl mx-auto'>
                    <motion.div  initial={{ y: 30, opacity: 0.0 }} whileInView={{ y:0, opacity:1.0 }} transition={{ duration:0.8, delay:0 }}>
                        <StrongCard 
                            title={"イメージに合ったデザイン"} 
                            num={1} 
                            description={"お客様のイメージ、ブランドに合った美しく機能的で豊かな表現力のあるWEBサイトの制作、感覚的に使える管理画面で運用にストレスを感じません。ハイクオリティでモダンなWEVサイトの制作がコストを抑えて可能です。高機能なサイトで顧客体験を改善します。"} 
                        >
                    ...
                    <motion.div initial={{ y: 30, opacity: 0.0 }} whileInView={{ y:0, opacity:1.0 }} transition={{ duration:0.8, delay:0.4 }}>
                        <StrongCard title={"優れたSEO対策"} num={3} description={"マルチプラでは構築したサイトは標準でSEO対策を行なっております。例えばサイトのメタ情報の登録、構造化データ、サイトマップの登録などを設定することでより精度の高いSEO対策を行うことができます。制作したサイトを２キーワードで1ページ表示を保証致します。例： マルチプラ 篠山 で１ページ目表示"} >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-10 md:w-10 lg:h-12 lg:w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1">
                    ...
                    <motion.div initial={{ y: 30, opacity: 0.0 }} whileInView={{ y:0, opacity:1.0 }} transition={{ duration:0.8, delay:0.6 }}>
                        <StrongCard title={"Shopifyの豊富な知識"} num={4} description={"Shopifを用いたECサイト制作、テーマの開発などお客さまに合わせたアプリの提案、販売チャネルの追加などShopify独自のエコシステムをお客さまのビジネスに合わせた提案が可能です。Shopifyは多機能な分使いこなすまで時間はかかりますがサポートプランをご用意しておりますので安心して始められます。"} >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-10 md:w-10 lg:h-12 lg:w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1">
                    ...
                    <motion.div initial={{ y: 30, opacity: 0.0 }} whileInView={{ y:0, opacity:1.0 }} transition={{ duration:0.8, delay:0.8 }}>
                        <StrongCard title={"最新技術で高速なWEBサイトを構築"} num={5} description={"最新技術を使用して表示速度を高速にし、顧客のコンバージョン率を高めることが可能です。ロード時間の長いサイトは直帰率が高く良い商品も結果が出難いです。サーバとのデータのやり取りにはAPIを独自開発し使用することでより高速で軽量なデータのやり取りが可能です。マルチプラのホームページようなストレスフリーで快適な使い心地のホームページにしませんか？"}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-10 md:w-10 lg:h-12 lg:w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1">
                    ...
                    <motion.div initial={{ y: 30, opacity: 0.0 }} whileInView={{ y:0, opacity:1.0 }} transition={{ duration:0.8, delay:1.0 }} >
                        <StrongCard title={"持続可能な運用体制の構築"} num={6} description={"WEBサイト制作後に行うべき対策は多岐にわたります。お客様のECサイトの運営体制構築までを注文から発送までの全ての工程においてお客様自身で運用できるまで徹底的にサポートさせて頂きますのでご安心ください。サポートプランのについてはお客様のニーズに合わせて柔軟位対応させて頂きますのでぜひお気軽にお問合せ下さい。"}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-10 md:w-10 lg:h-12 lg:w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1">
