    ...
    <>
      <div className="h-screen w-full sticky top-0 overflow-hidden -z-20">
        ...
        >
          <VideoPlayer
            mp4={
              "https://res.cloudinary.com/fdsfmsadlfmaslkdmfalksk/video/upload/v1659221709/output_compress-video-online.com_3_ooyono.mp4"
            }
            webm={
              "https://res.cloudinary.com/fdsfmsadlfmaslkdmfalksk/video/upload/v1659222180/output_compress-video-online.com_bgpd2o.webm"
            }
          />
          <div
          ...
          >
            <motion.div
              initial={{ scale: 1.0 }}
              animate={{
                scale: progress == 1 ? 1.0 : 1.0 + 1.01 * progress,
                opacity: 1 + -progress,
              }}
            ...
            >
              ...
              >
                ...
                <p className="text-sm md:text-base lg:text-lg text-gray-500 mt-1">
                  Multipla Web Developer
                </p>
              </motion.div>
            </motion.div>
            <motion.div
            ...
            >
              ...
              >
                <svg
                  ...
                  className="h-8 w-8 md:h-12 md:w-12 lg:w-16 lg:h-16 text-purple-700"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2"
