            ...
            <div className="h-screen w-full sticky top-0 overflow-hidden -z-20">
                <div style={{
                    ...
                    <div className={`absolute flex flex-col justify-around items-center w-full h-full`}>
                        ...
                        <motion.p initial={{ opacity: 0, y:30 }} animate={{ opacity: 1.0, y:0 }} transition={{ duration:0.8, delay: 0.8 }} className='text-shadow-xl text-shadow-black text-4xl md:text-6xl text-center lg:text-6xl w-fit h-fit -translate-x-1/2 font-bold font-noto_sans tracking-wide mt-12'>
                            ビジネスにWEBの力を<br/><span className="text-5xl text-purple-900">PLUS </span><span className="text-orange-400">+</span>
                        </motion.p>
                        </motion.div>
