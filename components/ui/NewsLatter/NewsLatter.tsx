                                ...
                                <div key={_news.id} className='bg-white shadow-md rounded-md py-1 md:py-3 px-2 md:px-5 mb-3 text-gray-500'>
                                    <div className='md:flex items-center  md:space-x-12 text-sm md:text-base'>
                                        <div className='my-2 flex items-center justify-between' >
                                            <p className='text-blue-600'>{_news.createdAt.split("T")[0]}</p><p className='ml-4 border border-green-500 px-3 rounded-full font-normal text-green-500'>{_news.category}</p>
                                        </div>
                                        <p>{_news.title}</p>
                                    </div>
                                </div>
