...
import { BlogCard } from "@components/ui/page/BlogContent"
    ...
    return (
        <div className='px-8 py-6 md:py-12 z-10 bg-white'>
                <div className=' max-w-6xl mx-auto'>
                    ...
                    <h3 className="text-center text-gray-700 my-6 font-bold text-2xl lg:texmt-3xl"><span className='text-black text-5xl lg:text-6xl'>MULTIPLA</span>ブログ</h3>
                    </motion.div>
                </div>
