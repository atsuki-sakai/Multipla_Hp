...
const VideoPlayer: FC<Props> = ({ mp4, webm, poster, onPlay }: Props) => {
    ...
    return (
        <video autoPlay loop muted playsInline onCanPlay={onPlay} onPlay={onPlay} style={{ objectFit:"cover", height:"100%", width:"100%" }} poster={poster} className='absolute w-full h-screen'>
